...
This was originally written and published https://gist.github.com/jcchurch/930276 this fork fixes print statement for newer versions of Python

This program is a good test of the mpi4py library, which is essentially a python wrapper to the C MPI library.

To execute this code:

mpiexec -np NUMBER_OF_PROCESSES -f NODES_FILE python pi.py
